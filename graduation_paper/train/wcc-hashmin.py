...
if __name__ == '__main__':
    ...
    # datasets, labels = GetAllData(extract_dir, fnum, 'wcc-hashmin', total_vertex_num=105896555, L=1000000)
    datasets, labels = GetAllData(extract_dir, fnum, 'wcc-hashmin', total_vertex_num=23947348, L=100000)
